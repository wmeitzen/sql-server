...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'DBA - Resumable Checktable - Sun 6am max 4 hr', 
		@enabled=0, 
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'restartable dbcc checktable', 
		@step_id=1, 
...
@maxDurationHrs = 4 -- hours; 0 = run until completion
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'Sun @ 6am', 
		@enabled=1, 
		@freq_type=8, 
		@freq_interval=1, 
		@freq_subday_type=1, 
		...
		@active_start_date=20211229, 
		@active_end_date=99991231, 
		@active_start_time=60000, 
		@active_end_time=235959, 
		@schedule_uid=N'9964703b-8695-447a-9023-e441eca41a5a'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
